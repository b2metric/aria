...
class TableEnrichment(BaseModel):
    ...
    data_domain: str | None = Field(None, description="Data domain (e.g., Customer, Product, Finance)")
...
def enrich_vault_table(
    ...
    try:
        ...
        frontmatter["enriched_at"] = datetime.now(timezone.utc).isoformat()
